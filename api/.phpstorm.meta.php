...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\Solaris\Documents\Solaris\GestionInventarios\api\public\storage' => 'string',
            'jwt.secret' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.C:\\Users\\Solaris\\Documents\\Solaris\\GestionInventarios\\api\\public\\storage','jwt.secret',
...
'jwt.blacklist_enabled','jwt.blacklist_grace_period','jwt.show_black_list_exception','jwt.decrypt_cookies','jwt.providers.jwt',
...
'sanctum.csrf-cookie','register','login','logout','refresh',
'me','role.index','role.create','role.store','role.show',
'role.edit','role.update','role.destroy',
'users.index','users.create','users.store','users.show','users.edit',
'users.update','users.destroy','sucursales.index','sucursales.create','sucursales.store',
'sucursales.show','sucursales.edit','sucursales.update','sucursales.destroy','warehouses.index',
'warehouses.create','warehouses.store','warehouses.show','warehouses.edit','warehouses.update',
'warehouses.destroy','categories.index','categories.create','categories.store',
'categories.show','categories.edit','categories.destroy','providers.index',
'providers.create','providers.store','providers.show','providers.edit','providers.update',
'providers.destroy','units.index','units.create','units.store','units.show',
'units.edit','units.update','units.destroy','unit-conversions.index','unit-conversions.create',
'unit-conversions.store','unit-conversions.show','unit-conversions.edit','unit-conversions.update','unit-conversions.destroy','products.index',
'products.create','products.store','products.show','products.edit','products.update',
'products.destroy','product-warehouse.index','product-warehouse.create','product-warehouse.store','product-warehouse.show',
'product-warehouse.edit','product-warehouse.update','product-warehouse.destroy','product-wallet.index','product-wallet.create',
'product-wallet.store','product-wallet.show','product-wallet.edit','product-wallet.update','product-wallet.destroy',
'clients.index','clients.create','clients.store','clients.show','clients.edit',
'clients.update','clients.destroy','sales.index','sales.create','sales.store',
'sales.show','sales.edit','sales.update','sales.destroy','sale_details.index',
'sale_details.create','sale_details.store','sale_details.show','sale_details.edit','sale_details.update',
'sale_details.destroy','sale_payments.index','sale_payments.create','sale_payments.store','sale_payments.show',
'sale_payments.edit','sale_payments.update','sale_payments.destroy',
'refound_products.index','refound_products.create','refound_products.store','refound_products.show','refound_products.edit',
'refound_products.update','refound_products.destroy','purchase.index',
'purchase.create','purchase.store','purchase.show','purchase.edit','purchase.update',
'purchase.destroy','purchase_details.index','purchase_details.create','purchase_details.store',
'purchase_details.show','purchase_details.edit','purchase_details.update','purchase_details.destroy','transports.index','transports.create','transports.store','transports.show',
'transports.edit','transports.update','transports.destroy',
'transport_details.index','transport_details.create','transport_details.store','transport_details.show','transport_details.edit',
'transport_details.update','transport_details.destroy','conversions.index','conversions.create',
'conversions.store','conversions.show','conversions.edit','conversions.update','conversions.destroy','storage.local',);
        registerArgumentsSet('views', 
'product.product_download_excel','purchase.pdf_purchase','sale.download_excel','sale.pdf_sale','transport.pdf_transport',
...
'AWS_URL','VITE_APP_NAME','JWT_SECRET','JWT_ALGO',);
