...
<template>
  <VCard class="position-relative">
    <VCardText>
      <div class="mb-3">
        <h5 class="text-h5 text-wrap">
          Felicidades <strong>{{ client_most_sale ? client_most_sale.client_most_sale : 'No hay cliente' }}!</strong>
    ...
    -->
    <VImg src="https://cdn-icons-png.flaticon.com/512/4814/4814961.png" class="trophy flip-in-rtl" />
  </VCard>
</template>
