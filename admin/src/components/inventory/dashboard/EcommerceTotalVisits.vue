...
<template>
  <VCard>
    <VCardText>
      <div class="d-flex align-center justify-space-between">
        ...
        <div class="d-flex justify-center" v-if="variation_percentage_sale_total_payment_complete < 0">
          ...
          <VIcon icon="ri-arrow-down-s-line" color="danger" size="20" />
        </div>
      </div>
      <h4 class="text-h4">
    ...
    <VCardText>
      <VRow no-gutters>
        <VCol cols="5">
          <div class="d-flex align-center mb-2">
            <VAvatar rounded color="warning" variant="tonal" :size="24" class="me-2">
        ...
        <VCol cols="5" class="text-end">
          <div class="d-flex align-center justify-end mb-2">
            ...
            <VAvatar rounded="sm" color="primary" variant="tonal" :size="24">
              <VIcon size="16" icon="ri-mac-line" />
            </VAvatar>
          </div>
          <h4 class="text-h4 mb-2">
      ...
      <div class="mt-4">
        <VProgressLinear :model-value="percentage_sale_payment_complete" color="warning" bg-color="primary"
