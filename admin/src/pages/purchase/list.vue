            ...
            <VCardText>
                <VRow class="">
                    <VCol cols="10">
                        <VRow>
                            <VCol cols="3">
                                <VTextField placeholder="Búsqueda N° Compra" density="compact" class="me-3"
                            ...
                            <VCol cols="3">
                                <VSelect placeholder="Select" label="Proveedor" :items="providers"
                                    item-title="full_name" item-value="id" v-model="provider_id">
                                </VSelect>
                            </VCol>
                    ...
                    <tr v-for="purchase in list_purchases" :key="purchase.id">
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                ...
                                <IconBtn size="small" @click="editItem(purchase)" v-if="isPermission('edit_purchase')">
