...
<template>
    <div>
                ...
                <VCard class="mb-6" title="Información General">
                    <VCardText>
                        <VRow>
                            ...
                            <VCol cols="3">
                                <VSelect v-model="warehouse_id" :items="warehouses" label="Almacenes"
                                    placeholder="Select Almacen" item-title="name" item-value="id" eager disabled />
                            </VCol>
                            <VCol cols="3">
                    ...
                    <VTable>
                        ...
                        <tbody>
                            ...
                            <tr v-for="(purchase_detail, index) in purchase_details" :key="index">
                                <td>
                                    <VBtn v-if="purchase_detail.state == 1"
                                        @click="purchaseDetailAttention(purchase_detail)" icon="ri-contract-line"
                                        variant="text" />
                                </td>
                                <td>
                                ...
                                <td class="d-flex align-center">
                                    <IconBtn size="small" @click="editPurchaseDetail(purchase_detail)">
                                        <VIcon icon="ri-pencil-line" />
                                    </IconBtn>
                                    <IconBtn size="small" v-if="purchase_detail.state != 2"
        ...
        <PurchaseDetailEditDialog v-if="purchase_detail_selected && isPurchaseDetailDialogVisible"
            v-model:isDialogVisible="isPurchaseDetailDialogVisible" :purchaseDetailSelected="purchase_detail_selected"
            :units="units" :purchase_id="route.params.id" @editPurchaseDetail="purchaseDetailEdit">

        </PurchaseDetailEditDialog>

        <PurchaseDetailDeleteDialog v-if="purchase_detail_delete_selected && isPurchaseDetailDeleteDialogVisible"
            v-model:isDialogVisible="isPurchaseDetailDeleteDialogVisible"
            :purchaseDetailSelected="purchase_detail_delete_selected" @deletePurchaseDetail="purchaseDetailDelete">
