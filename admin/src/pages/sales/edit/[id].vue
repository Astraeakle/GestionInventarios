    ...
    <div>
        ...
        <VCard class="mb-6">
            <VCardText>
                <VRow>
                    <VCol cols="3">
                        <AppDateTimePicker v-model="date_emision" label="Fecha de Emision" placeholder="Select date"
                            disabled />
                    </VCol>
                    <VCol cols="3">
                    ...
                    <VCol cols="4">
                        <VRow>
                            <VCol cols="12">
                                <VTextField label="Cliente" v-model="search_client" prepend-inner-icon="ri-user-6-line"
                                    placeholder="" @keyup.enter="searchClient()" />
                            </VCol>
                        ...
                        <VRow>
                            <VCol cols="12">
                                <VAutocomplete v-model="select_product" v-model:search="search_product"
                                    ...
                                    placeholder="Search for a product" label="¿Que agregamos?" variant="underlined"
                        ...
                        <VRow>
                            <VCol cols="10">
                                <VRow>
                                    ...
                                    <VCol cols="4">
                                        <VTextField label="Precio" type="number" v-model="price_unit" placeholder=""
                                ...
                                <tr v-for="(sale_detail, index) in sale_details" :key="index">
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <IconBtn size="small" @click="editIDetail(sale_detail)">
            ...
            <VCardText>
                <VRow>
                    <VCol cols="8" v-if="selectedRadio == 1">
                        <VRow>
                            <VCol cols="4">
                                <VSelect placeholder="Select" label="Metodos de Pago" :items="[
                                    'EFECTIVO',
                                    'DEPOSITO',
                                    'TRANSFERENCIA',
                                    'YAPE',
                            ...
                            <VCol cols="4">
                                <VTextField label="Monto" type="number" v-model="amount" placeholder="" />
                            </VCol>
                            <VCol cols="4">
                                    ...
                                    <tbody>
                                        <tr v-for="(payment, index) in payments" :key="index">
                                            ...
                                            <td>
                                                ...
                                                <IconBtn size="small" @click="deletePayment(payment)">
                                                    <VIcon icon="ri-delete-bin-line" />
                                                </IconBtn>
                                            </td>
                                        </tr>
                    ...
                    <VCol cols="4">
                        <VTextarea label="Descripción" placeholder="" v-model="description" />
                    </VCol>
        ...
        <DetailEditDialog v-if="selected_detail_edit && isDetailEditDialogVisible"
            ...
            @editSaleDetail="saleDetailUpdate"></DetailEditDialog>
        ...
        <PaymentDeleteDialog v-if="selected_payment_delete && isPaymentDeleteDiagoVisible"
            v-model:isDialogVisible="isPaymentDeleteDiagoVisible" :paymentSelected="selected_payment_delete"
